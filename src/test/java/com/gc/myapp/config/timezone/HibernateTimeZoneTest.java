package com.gc.myapp.config.timezone;

import com.gc.myapp.ElasticTestApp;
import com.gc.myapp.repository.timezone.DateTimeWrapper;
import com.gc.myapp.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = ElasticTestApp.class)
